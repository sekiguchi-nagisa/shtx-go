...
var CLI struct {
	...
	PatternType   string  `name:"pattern-type" short:"p" help:"Set type of pattern (whole, partial, start, end, forward-short, forward-long, forward-short, backward-long)" enum:"whole,partial,start,end,forward-short,forward-long,forward-short,backward-long" default:"whole"`
