...
var glob2RegexOptions = map[string]Glob2RegexOption{
	...
	"backward-short": {startsWith: false, endsWith: true, backward: true},                  // '%'
	"backward-long":  {startsWith: false, endsWith: true, reluctant: true, backward: true}, // '%%'
}
